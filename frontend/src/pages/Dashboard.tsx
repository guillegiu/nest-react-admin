  ...
  return (
    <Layout>
      <div className="main-header">
        <h1 className="font-semibold text-2xl text-gray-700">{t('dashboard.title')}</h1>
      </div>
            ...
            <div className="flex flex-col sm:flex-row gap-5">
              {authenticatedUser.role === 'admin' && (
                <div className="card shadow text-white bg-red-500 flex-1">
                  ...
                  <p className="text-center sm:text-lg font-semibold">{t('dashboard.stats.users')}</p>
                </div>
              )}
              <div className="card shadow text-white bg-red-600 flex-1">
                ...
                <p className="text-center sm:text-lg font-semibold">{t('dashboard.stats.courses')}</p>
              </div>
              <div className="card shadow text-white bg-red-700 flex-1">
                <h1 className="font-semibold sm:text-4xl mb-3 text-center">
                  {data.numberOfContents}
                </h1>
                <p className="text-center sm:text-lg font-semibold">{t('dashboard.stats.contents')}</p>
              </div>
            </div>
          ) : null}
